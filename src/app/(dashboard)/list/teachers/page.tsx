  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-base md:text-lg font-semibold">All Teachers</h1>
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            ...
            {role === "admin" && <FormContainer table="teacher" type="create" relatedData={{ subjects }} />}
          </div>
        </div>
      </div>
      {/* LIST */}
      <Table columns={columns} renderRow={item => (
        ...
        >
          ...
          <td className="hidden md:table-cell">
            {item.subjects.map((subjectItem: Subject) => subjectItem.name).join(",")}
          </td>
          <td className="hidden md:table-cell">
